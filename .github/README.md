...
[`@aws-sdk/client-deadline`](https://www.npmjs.com/package/@aws-sdk/client-deadline/v/3.926.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-deadline@3.926.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H2O+Lw3DSCLWyXrtQ8tJ9ywpH0PWNUZtY1XHDlOzav1W2/OoQDNvGPoBpgDCMVtY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-deadline": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-deadline@3.926.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-deadline@3.926.0/index.min.mjs": "sha384-H2O+Lw3DSCLWyXrtQ8tJ9ywpH0PWNUZtY1XHDlOzav1W2/OoQDNvGPoBpgDCMVtY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-deadline/blob/refs/tags/3.926.0/LICENSE
```
