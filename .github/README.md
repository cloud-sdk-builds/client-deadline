...
[`@aws-sdk/client-deadline`](https://www.npmjs.com/package/@aws-sdk/client-deadline/v/3.928.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-deadline@3.928.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/Q5B0HNu+pp9rHE1yecc0ePodiV66QpVBtGrg+is21xtaO/N89we8sK+3yPoY9pn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-deadline": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-deadline@3.928.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-deadline@3.928.0/index.min.mjs": "sha384-/Q5B0HNu+pp9rHE1yecc0ePodiV66QpVBtGrg+is21xtaO/N89we8sK+3yPoY9pn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-deadline/blob/refs/tags/3.928.0/LICENSE
```
